...
3. Make your change. Follow
   [KitoSignature's engineering standards](https://github.com/WykSofts-Inc/KitoSignature/blob/main/docs/ENGINEERING_STANDARDS.md) —
